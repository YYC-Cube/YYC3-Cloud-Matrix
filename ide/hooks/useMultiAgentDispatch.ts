...
function resolveProvider(): { provider: ProviderConfig; modelId: string } | null {
  // Priority: 自建vLLM > Ollama > 智谱 (vLLM First)
  const priority: Array<{ providerId: string; defaultModel: string }> = [
    { providerId: 'vllm-n1-27b', defaultModel: 'Qwen3.6-27B' },
    { providerId: 'vllm-n1-35b', defaultModel: 'Qwen3.6-35B-A3B' },
    { providerId: 'ollama-n1-coder', defaultModel: 'qwen3-coder-30b-a3b' },
    { providerId: 'ollama', defaultModel: 'llama3' },
    { providerId: 'zai-plan', defaultModel: 'glm-5' },
  ]
