...
// ================================================================
// 使用方式：
// import { DIContainer, ConfigManager, ILogger } from './ide'
// import { TOKENS, Lifecycle, ServiceToken } from './ide/di'
// import { createYYC3ConfigManager, DEFAULT_CONFIG } from './ide/config'
// ================================================================
...
export {
  ...
  BRAND_COPYRIGHT,
  BRAND_TEAM,
  BRAND_FONT_FAMILY_SANS,
  BRAND_FONT_FAMILY_MONO,
  BRAND_BREAKPOINTS,
  BRAND_TRANSITION_FAST,
  BRAND_TRANSITION_NORMAL,
  BRAND_TRANSITION_SLOW,
  Z_INDEX,
...
export {
  ...
  AI_RETRY_DELAY,
  PERF_DEBOUNCE_DELAY,
  PERF_VIRTUAL_SCROLL_THRESHOLD,
  PERF_MAX_FILE_TREE_DEPTH,
  PERF_LAZY_LOAD_THRESHOLD,
...
export {
  UserFeedbackManager,
} from './feedback/UserFeedbackManager';
export type {
  FeedbackType,
  FeedbackPriority,
  FeedbackStatus,
...
export type {
  ExportOptions,
  ImportResult,
} from './adapters/ProjectExporter';

// ── AI 管线 (AI Pipeline) ──
export { SystemPromptBuilder } from './ai/SystemPromptBuilder';
export {
  detectIntent,
  buildSystemPrompt,
  buildChatMessages,
...
// ── 版本信息 ──
export const IDE_STANDARD_VERSION = '2.1.0';
