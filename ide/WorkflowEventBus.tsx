...
export type WorkflowEventType =
  ...
  // AI Family Events (8家人专属事件)
  | "tianshu-dispatch" // 元启·天枢 — 全局调度
  | "qianhang-navigate" // 言启·千行 — 意图路由
  | "wanwu-analyze" // 语枢·万物 — 数据分析
  | "xianzhi-predict" // 预见·先知 — 趋势预测
  | "bole-retrieve" // 知遇·伯乐 — 知识检索
  | "shouhu-scan" // 智云·守护 — 安全扫描
  | "zongshi-review" // 格物·宗师 — 质量审核
  | "lingyun-design"; // 创想·灵韵 — 创意设计
...
> = {
  ...
  // AI Family Events
  "tianshu-dispatch": { workflowId: "ai-assist", stageId: "ai-1" },
  "qianhang-navigate": { workflowId: "ai-assist", stageId: "ai-2" },
  "wanwu-analyze": { workflowId: "ai-assist", stageId: "ai-3" },
  "xianzhi-predict": { workflowId: "ai-assist", stageId: "ai-4" },
  "bole-retrieve": { workflowId: "ai-assist", stageId: "ai-5" },
  "shouhu-scan": { workflowId: "ai-assist", stageId: "ai-6" },
  "zongshi-review": { workflowId: "ai-assist", stageId: "ai-7" },
  "lingyun-design": { workflowId: "ai-assist", stageId: "ai-8" },
};
