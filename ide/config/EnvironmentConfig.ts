...
export const DEFAULT_GATEWAYS: GatewayConfig[] = [
  {
    id: 'yyc3-vllm-n1',
    name: 'YYC³ DGX N1 (内网主节点)',
    url: 'http://192.168.3.101:8000/v1',
    description: 'Qwen3.6-27B nvFP4 · LoRA热加载 · 内网直连 · 零延迟',
    auth: {
      method: 'none',
      credentials: {},
    },
  ...
  {
    id: 'yyc3-vllm-n1-moe',
    name: 'YYC³ DGX N1 MoE (内网)',
    url: 'http://192.168.3.101:8001/v1',
    description: 'Qwen3.6-35B-A3B MoE nvFP4 · 代码/意图专精',
    auth: {
      method: 'none',
      credentials: {},
    },
  ...
  },
  {
    ...
    description: 'YYC³ LLM 统一网关 - 外网降级备用',
    auth: {
      method: 'api_key',
      credentials: { apiKey: '' },
    },
