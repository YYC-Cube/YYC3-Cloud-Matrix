...
import { useFamilySettingsSlice, migrateLegacyUIConfig } from "../store/family-settings-slice";
import type { FamilyUIConfig } from "../store/family-settings-slice";
...
const ECOSYSTEM_LINKS: LinkNode[] = [
  { id: "home", name: "家族首页", icon: Heart, color: "#FF69B4", path: "/ai-family/home", description: "家人状态 · 动态 · 空间入口" },
  { id: "center", name: "Family中心", icon: Sparkles, color: "#FF69B4", path: "/ai-family/center", description: "全景规划 · 信任公约" },
