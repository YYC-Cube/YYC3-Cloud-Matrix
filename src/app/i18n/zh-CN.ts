...
const zhCN = {
  ...
  nav: {
    ...
    aiFamilyPhone: "家人热线",
    aiFamilyFun: "娱乐活动",
    aiFamilyActivities: "活动中心",
    aiFamilyModels: "模型设置",
    aiFamilyVoice: "语音系统",
    aiFamilyData: "数据中心",
    aiFamilyComm: "通讯中心",
    aiFamilyEcosystem: "家族首页",
  },
  ...
  ai: {
    ...
    familyTab: "AI Family",
    familySearchPlaceholder: "搜索家人能力、专业技能...",
    familyScenarios: "场景导航 · 九层架构",
    familyTasks: "协同任务队列",
    callMember: "呼叫",
    chatMember: "私信",
    consultMember: "咨询",
    collaborateMember: "协同",
    initiateCollaboration: "发起协同任务",
    onlineStatus: "在线",
    memberCount: "家人",
  ...
  settings: {
    ...
    envConfig: "环境变量",
    localMode: "本地模式",
    unifiedSettingsDesc: "数据完全本地化，绝对安全，随心驾驭",
    dataIsolationDesc: "验证您的数据完全存储在本地，不上传任何信息",
    noCloudSync: "无云端同步",
    noTracking: "无数据追踪",
    noThirdParty: "无第三方服务",
    offlineReady: "离线可用",
    apiKeyDesc: "您的 API 密钥仅存储在本地浏览器中，永远不会上传到任何服务器",
    keyStored: "密钥已存储",
    dataExport: "数据导出",
    dataExportDesc: "将所有设置和数据导出为 JSON 文件，便于备份或迁移",
    exportAll: "导出全部数据",
    dataImport: "数据导入",
    clearDataDesc: "清除所有本地存储的数据，此操作不可恢复",
    storageUsage: "存储空间使用",
    storageLimit: "浏览器本地存储限制约 5MB",
    store: "存储",
    principle2: "本地化存储：所有数据存储在本地浏览器",
    principle3: "一用户一端：单用户单设备，无云端同步",
    principle4: "数据完全隔离：不上传任何数据到服务器",
    right2: "随时导出所有数据",
    right4: "离线使用所有功能",
    ...
    importFailed: "数据导入失败",
    importInvalid: "无效的数据文件",
    clearSuccess: "数据已清除",
    unifiedSettings: "统一设置管理",
    dataIsolation: "数据隔离验证",
    verified: "已验证",
    ssot: "统一设置",
    toggles: "项配置",
    notInit: "未初始化",
    ...
    dataImportDesc: "从备份文件恢复设置和数据",
    fullRestore: "全量恢复",
    cryptoAvailable: "加密引擎可用",
    cryptoUnavailable: "加密引擎不可用",
    clearData: "清除数据",
    clearAllData: "清除所有数据",
    confirmClear: "确认清除数据？",
    confirmClearDesc: "此操作将清除所有本地数据，包括设置、模型配置、数据库连接等。此操作不可恢复。",
    totalUsage: "总使用量",
    session: "会话",
    cache: "缓存",
    dataOverview: "数据概览",
  ...
  ide: {
    ...
    terminalHelpHint: "输入 'help' 查看可用命令。Tab 键自动补全。",
    terminalHelpTitle: "━━━━ YYC³ 终端命令 ━━━━",
    terminalSystemTitle: "━━━━ 系统 ━━━━",
    terminalGitTitle: "━━━━ Git ━━━━",
    terminalNpmTitle: "━━━━ NPM/PNPM ━━━━",
    terminalUtilsTitle: "━━━━ 工具 ━━━━",
    terminalNewSession: "新建终端会话",
    commandNotFound: "命令未找到: {cmd}",
    helpHint: "输入 'help' 查看可用命令。",
    // Search
    searchPlaceholder: "搜索文件、命令、设置...",
    searchHint: "(Esc 关闭)",
    // Notifications
    ...
    tabSize: "缩进大小",
    settingsTabSize: "缩进大小",
    wordWrap: "自动换行",
    settingsWordWrap: "自动换行",
    minimap: "迷你地图",
    settingsMinimap: "迷你地图",
    lineNumbers: "行号",
    settingsLineNumbers: "行号",
    autoSave: "自动保存",
    settingsAutoSave: "自动保存",
    autoSaveDelay: "自动保存延迟 (ms)",
    formatOnSave: "保存时格式化",
    settingsFormatOnSave: "保存时格式化",
    bracketColor: "括号着色",
    settingsBracketColorization: "括号着色",
    ...
    settingsThemeCyberpunk: "赛博朋克",
    // Deploy
    deployTitle: "部署项目",
    deployEnv: "部署环境",
    deployProduction: "生产环境",
    deployStaging: "预发布环境",
    deployDevelopment: "开发环境",
    deployStart: "开始构建",
    deployBuilding: "构建中...",
    deployLogs: "构建日志",
    deploySuccess: "部署成功!",
